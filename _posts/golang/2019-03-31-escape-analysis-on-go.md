...
![](/assets/image/golang/golang_escape_analysis_figure1.jpg)
...
![](/assets/image/golang/golang_escape_analysis_figure2.jpg)
...
在函数调用之后，您可以将堆栈理解成这样。
![](/assets/image/golang/golang_escape_analysis_figure3.jpg)
